...
transformer_configs = {
    ...
    "Mixtral-8x7B-Instruct-v0.1": dict(n_layer=32, n_head=32, n_local_heads=8, dim=4096, intermediate_size=14336, num_local_experts=8, num_experts_per_tok=2, rope_base=1000000),
}
...
class Transformer(nn.Module):
    def __init__(self, config: ModelArgs) -> None:
        ...
        Block = MixtralBlock if config.num_local_experts is not None else TransformerBlock
